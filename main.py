...
def count_down(count):
    ...
    if count > 0:
        ...
        timer = window.after(1000, count_down, count - 1)  # after 1000 milliseconds
    else:
        start_timer()
        marks = ""
...
# Check_mark label
check_marks_label = Label(fg=GREEN, bg=YELLOW, font=15)
...
# bg= background' color
# fg= foreground' color (text's color)
# highlightthickness= label's borders
